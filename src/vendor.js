 ...
 * were using in this project. this is used by webpack
 * in the production build only. A separate bundle for vendor
 * code is useful sine it's unlikely to  change as often a
 * as the application's code. So all the libraries we refence
 ...
 * a vendor library changes shich should be less frequent.
